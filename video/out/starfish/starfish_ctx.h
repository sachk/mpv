...
STARFISH_CTX_API bool starfish_ctx_set_window_id(struct starfish_ctx *ctx, const char *window_id);
STARFISH_CTX_API bool starfish_ctx_set_numeric_window_id(struct starfish_ctx *ctx, int64_t wid);
STARFISH_CTX_API bool starfish_ctx_set_video_geometry(struct starfish_ctx *ctx, int width,
                                                      int height, double fps);
STARFISH_CTX_API bool starfish_ctx_set_display_window(struct starfish_ctx *ctx,
                                                      int src_x, int src_y, int src_w, int src_h,
                                                      int dst_x, int dst_y, int dst_w, int dst_h);
STARFISH_CTX_API bool starfish_ctx_configure_video(struct starfish_ctx *ctx,
                                                   const struct mp_codec_params *codec);
STARFISH_CTX_API bool starfish_ctx_configure_audio_passthrough(struct starfish_ctx *ctx,
                                                               int format, int samplerate,
                                                               const struct mp_chmap *channels);
STARFISH_CTX_API bool starfish_ctx_configure_audio_aac(struct starfish_ctx *ctx, int channels,
                                                       int samplerate, int profile, bool raw);

STARFISH_CTX_API int starfish_ctx_feed_video(struct starfish_ctx *ctx, const void *data,
                                             size_t size, double pts);
STARFISH_CTX_API int starfish_ctx_feed_audio(struct starfish_ctx *ctx, const void *data,
                                             size_t size, int64_t pts_ns);
STARFISH_CTX_API bool starfish_ctx_pop_video_frame(struct starfish_ctx *ctx,
