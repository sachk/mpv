...
const struct m_sub_options mp_subtitle_sub_opts = {
    .opts = (const struct m_option[]){
        ...
        {"sub-sdf-softness", OPT_FLOAT(sub_sdf_softness), M_RANGE(0.5, 2.0)},
        {"sub-sdf-shadow", OPT_BOOL(sub_sdf_shadow)},
        {"sub-sdf-shadow-core-sigma", OPT_FLOAT(sub_sdf_shadow_core_sigma), M_RANGE(0.1, 4.0)},
        {"sub-sdf-shadow-core-grow", OPT_FLOAT(sub_sdf_shadow_core_grow), M_RANGE(0.0, 4.0)},
        {"sub-sdf-shadow-core-opacity", OPT_FLOAT(sub_sdf_shadow_core_opacity), M_RANGE(0.0, 1.0)},
        {"sub-sdf-shadow-spread", OPT_BOOL(sub_sdf_shadow_spread)},
        {"sub-sdf-shadow-spread-sigma", OPT_FLOAT(sub_sdf_shadow_spread_sigma), M_RANGE(1.0, 16.0)},
        {"sub-sdf-shadow-spread-grow", OPT_FLOAT(sub_sdf_shadow_spread_grow), M_RANGE(0.0, 8.0)},
        {"sub-sdf-shadow-spread-x", OPT_FLOAT(sub_sdf_shadow_spread_x), M_RANGE(-16.0, 16.0)},
        {"sub-sdf-shadow-spread-y", OPT_FLOAT(sub_sdf_shadow_spread_y), M_RANGE(-16.0, 16.0)},
        {"sub-sdf-shadow-spread-opacity", OPT_FLOAT(sub_sdf_shadow_spread_opacity), M_RANGE(0.0, 1.0)},
        {"sub-sdf-shadow-dither", OPT_BOOL(sub_sdf_shadow_dither)},
        {"sub-gray", OPT_BOOL(sub_gray)},
        {"sub-ass", OPT_BOOL(ass_enabled), .flags = UPDATE_SUB_ASS_HARD},
        ...
        {"embeddedfonts", OPT_BOOL(use_embedded_fonts), .flags = UPDATE_SUB_ASS_HARD},
        {"sub-ass-style-overrides", OPT_STRINGLIST(ass_style_override_list),
            .flags = UPDATE_SUB_ASS_HARD},
        {"sub-ass-styles", OPT_STRING(ass_styles_file),
            .flags = M_OPT_FILE | UPDATE_SUB_ASS_HARD},
    ...
    .defaults = &(OPT_BASE_STRUCT){
        ...
        .ass_prune_delay = -1.0,
        .teletext_page = 0,
        .sub_sdf_softness = 1.0,
        .sub_sdf_shadow = true,
        .sub_sdf_shadow_core_sigma = 1.0,
        .sub_sdf_shadow_core_grow = 1.0,
        .sub_sdf_shadow_core_opacity = 0.7,
        .sub_sdf_shadow_spread = true,
        .sub_sdf_shadow_spread_sigma = 6.0,
        .sub_sdf_shadow_spread_grow = 0.0,
        .sub_sdf_shadow_spread_x = 2.0,
        .sub_sdf_shadow_spread_y = 3.0,
        .sub_sdf_shadow_spread_opacity = 0.3,
        .sub_sdf_shadow_dither = true,
